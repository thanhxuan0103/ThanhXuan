          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    @if($data->UserGroup->GroupName =='Quản trị hệ thống')
                          ...
                          <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                          ...
                                          <div class="card-body p-0 ">
                                              <div class="cust-title p-3">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                      ...
                                                      @php
                                                            $result = DB::select('SELECT * FROM `taskinfo` WHERE `ExpectToEnd` < DATE_ADD(CURDATE(),INTERVAL 3 DAY) AND `ExpectToEnd` > CURDATE() AND TaskidUser ='.$data->id);
                                                        @endphp
                                                      <a class="badge badge-primary badge-card" href="#">{{count($result)}}</a>
                                                  </div>
                                              </div>
                                                      ...
                                                      <div class="media align-items-center cust-card py-3 border-bottom">
                                                          <div class="media-body ml-3">
                                                              <div class="d-flex align-items-center justify-content-between">
                                                                  ...
                                                                  <small class="text-dark"><b>{{$task->ExpectToEnd}}</b></small>
                                                              </div>
                                                              <small class="mb-0">Công việc tới hạn</small>
                                                          </div>
                                                      </div>
                                                  </a>
                                                  @endforeach
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                      ...
                                      <img src="{{url('public/site')}}/images/user/1.png" class="img-fluid rounded" alt="user">
                                        @else
                                          ...
                                          <div class="card-body p-0 text-center">
                                              <div class="media-body profile-detail text-center">
                                                  <img src="{{url('public/site')}}/images/page-img/profile-bg.jpg" alt="profile-bg"
                                                      ...
                                                      @if(empty($avatar[0]->File))
                                                  <img src="{{url('public/site')}}/images/user/1.png" alt="profile-img"
