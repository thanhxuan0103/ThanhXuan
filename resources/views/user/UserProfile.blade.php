                  ...
                  <div class="card-body">
                     <div class="d-flex align-items-center mb-3">
                        <div class="profile-img position-relative">
                            @if($avatar!=null)
                           <img src="{{url('storage/app/Avatars')}}/{{$avatar[0]->File}}" class="img-fluid rounded avatar-110" alt="profile-image">
                           @else
                           <img src="{{url('storage/app/Avatars')}}/1.png" class="img-fluid rounded avatar-110" alt="profile-image">
                           @endif
                        </div>
                        <div class="ml-3">
                           <h4 class="mb-1">{{$data->name}}</h4>
                           <p class="mb-2">{{ !empty($data->UserGroup) ? $data->UserGroup->GroupName:'' }}</p>
                     ...
                     <ul class="list-inline p-0 m-0">
                        <li class="mb-2">
                           <div class="d-flex align-items-center">
                              ...
                              <p class="mb-0">CTICT. Cần Thơ, Việt Nam</p>
                           </div>
                        </li>
                        <li class="mb-2">
                           <div class="d-flex align-items-center">
                              ...
                              <p class="mb-0">Chức vụ: {{ !empty($data->UserGroup) ? $data->UserGroup->GroupName:'' }}</p>
                           </div>
                        </li>
                        <li class="mb-2">
                           <div class="d-flex align-items-center">
