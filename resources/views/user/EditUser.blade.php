            ...
            <div class="row">
                <div class="col-xl-12 col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('storeUpdateUser') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select   name="idUserGroup" id="idUserGroup" class=" selectpicker form-control" data-style="py-0">
                                            <option selected disabled value="">--Chọn loại người dùng--</option>
                                            @foreach ($Group as $Group)

                                                <option value="{{ !empty($Group->GroupName) ? $Group->GroupName:'' }} ">
