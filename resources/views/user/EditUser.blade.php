                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('UpdateUser') }}">
                                    ...
                                    <div class="col-md-6">
                                        <select   name="idUserGroup" id="idUserGroup" class=" selectpicker form-control" data-style="py-0" required>
                                            ...
                                            @foreach ($data1 as $usergroup)
                                                @if ($data->idUserGroup == $usergroup->idUserGroup)
                                                <option selected value="{{ $usergroup->idUserGroup }} ">
                                ...
                                <div class="row mb-3">
                                    <label for="password"  class="col-md-4 col-form-label text-md-end">Reset Mật khẩu</label>

                                    <div class="col-md-6">
                                        <select   name="resetpassword" id="resetpassword" class=" selectpicker form-control" data-style="py-0" required>
