                    ...
                    <div class="card-body">
                        <form action="page-list-product.html" data-toggle="validator">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Thông tin người đầu mối phối hợp</label>
                                        <textarea class="form-control" rows="1"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Ghi chú</label>
                                        <textarea class=" class=" form-control" rows="4" name="NotePageEditProduct" required></textarea>
                                        <script>
                                            CKEDITOR.replace('NotePageEditProduct');
                                        </script>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
