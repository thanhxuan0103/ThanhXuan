                                        ...
                                        <td>
                                            <div class="d-flex align-items-center list-action">
                                                ...
                                                <a class="badge bg-danger mr-2 "
                                                    ...
                                                    data-target="#ModalDownloadYCKH" id="BtnShowFileReqData" data-placement="top" title=""
                                                    data-original-title="Download" href="#"><i
                                                        class="ri-download-2-line mr-0"></i></a>
                                                <a id="AddUserToContract" class="badge  bg-warning mr-2" data-toggle="modal"
                                                    data-placement="top" title="" data-original-title="Add"
                                                    data-target="#ModalAddYCKH" href="#"><i
