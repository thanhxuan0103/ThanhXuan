...
<style>
  ...
  min-height: 450px;
                                    ...
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <a href="page-add-sale.html" id="assign-task" class="btn btn-primary add-list"
                                            url="{{ route('GetDevOfContract') }}" idContract="{{ $idContract }}"
                                             data-toggle="modal"
                                            data-target="#ModalAssignTask"><i class="las la-plus mr-3"></i>Thêm nhiệm vụ</a>
                                    </div>
                                    <div class="card-body">
                                        <form>
                                            <div class="col-lg-12">
                                                        ...
                                                        <tbody class="ligth-body">
                                                            @foreach($taskInfo as $TI)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ !empty($TI->TaskEndTime) ? $TI->TaskEndTime:'-----------' }}</td>
                                                                    @if($TI->Status == 0)
                                                                    <td>
    ...
    <script type="text/javascript" src="{{url('public/site')}}/js/softwarebuild.js"></script>
