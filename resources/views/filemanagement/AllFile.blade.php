                        ...
                        @foreach ($files as $file)
                         ...
                         <td>
                            <div class="d-flex align-items-center list-action">
                               ...
                               <a class="badge bg-danger mr-2" data-toggle="modal"
                               data-target="#ModalDownloadAllFile" data-placement="top" title="" data-original-title="Download"  href="#"><i class="ri-download-2-line mr-0"></i></a>
