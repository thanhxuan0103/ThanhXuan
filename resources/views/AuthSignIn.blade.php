                           ...
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 ...
                                 <form action="{{route('ValidateLogin')}}" method="POST">
                                    @if(Session::has('fail'))
                                    <div class="alert alert-danger " style="height: 50px">{{Session::get('fail')}}</div>
                                    @endif
                                    @csrf
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input value="{{old('email')}}" name="email" style="height: 50px !important;" class="floating-input form-control" type="" placeholder=" ">
                                             <label>Email</label>
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input name="password" style="height: 50px !important;" class="floating-input form-control" type="password" placeholder=" ">
