...
<!-- Modal View Start -->
<!-- Modal -->
<!-- <div class="modal fade" id="ModalViewListSale" tabindex="-1" role="dialog" aria-labelledby="exampleModalViewListSale" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalViewListSale">Tiến trình xây dựng phần mềm</h5>
                  ...
                  <div class="card-body">
                     <div class="d-flex align-items-center mb-3">
                        <div class="profile-img position-relative">
                           <img src="{{url('public/site')}}/images/user/1.png" class="img-fluid rounded avatar-110" alt="profile-image">
                        </div>
                        <div class="ml-3">
                                 ...
                                 <ul class="list-inline p-0 m-0">
                                    <li class="mb-4">
                                       <div class="d-flex align-items-center pt-2">
                                          <img src="{{url('public/site')}}/images/profile/service/01.png" class="img-fluid" alt="image">
                                    ...
                                    <li class="mb-4">
                                       <div class="d-flex align-items-center pt-2">
                                          <img src="{{url('public/site')}}/images/profile/service/02.png" class="img-fluid mr-3" alt="image">
                                          <div class="ml-3 w-100">
                                             <div class="media align-items-center justify-content-between">
                                    ...
                                    <li>
                                       <div class="d-flex align-items-center pt-2">
                                          <img src="{{url('public/site')}}/images/profile/service/03.png" class="img-fluid" alt="image">
                                          <div class="ml-3 w-100">
                                             <div class="media align-items-center justify-content-between">
                                                <p class="mb-0">Adobe Photoshop</p>
                                                <h6>85%</h6>
...
<!-- Modal View End -->
      <!-- Modal Add Start -->
<div class="modal fade" id="ModalAddListSale" tabindex="-1" role="dialog" aria-labelledby="exampleModalAddListSale" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalAddListSale">Thêm người dùng</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="ModalDownloadListSale" tabindex="-1" role="dialog" aria-labelledby="exampleModalDownloadListSale" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalDownloadListSale">Danh sách File liên quan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
