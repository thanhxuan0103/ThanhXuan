                     ...
                     <div class="card">
                        <div class="card-body p-0">
                           <ul class="todo-task-lists m-0 p-0">
                              ...
                              <li class="d-flex align-items-center p-3">
                                 <div class="user-img img-fluid"><img src="{{url('public/site')}}/images/user/03.jpg" alt="story-img" class="rounded avatar-40"></div>
                                 <div class="media-support-info ml-3">
                              ...
                              <li class="d-flex align-items-center p-3">
                                 <div class="user-img img-fluid"><img src="{{url('public/site')}}/images/user/04.jpg" alt="story-img" class="rounded avatar-40"></div>
                                 <div class="media-support-info ml-3">
                              ...
                              <li class="d-flex align-items-center p-3">
                                 <div class="user-img img-fluid"><img src="{{url('public/site')}}/images/user/05.jpg" alt="story-img" class="rounded avatar-40"></div>
                                 <div class="media-support-info ml-3">
                              ...
                              <li class="d-flex align-items-center p-3">
                                 <div class="user-img img-fluid"><img src="{{url('public/site')}}/images/user/06.jpg" alt="story-img" class="rounded avatar-40"></div>
                                 <div class="media-support-info ml-3">
                              ...
                              <li class="d-flex align-items-center p-3">
                                 <div class="user-img img-fluid"><img src="{{url('public/site')}}/images/user/07.jpg" alt="story-img" class="rounded avatar-40"></div>
                                 <div class="media-support-info ml-3">
